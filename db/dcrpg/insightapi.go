...
// GetRawTransaction gets a hxjson.TxRawResult for the specified transaction
// hash.
func (pgb *ChainDBRPC) GetRawTransaction(txid string) (*hxjson.TxRawResult, error) {
...
func (pgb *ChainDBRPC) InsightGetAddressTransactions(addr string, count,
	skip int) []*hxjson.SearchRawTransactionsResult {
...
// GetBlockVerboseByHash returns a *hxjson.GetBlockVerboseResult for the
// specified block hash, optionally with transaction details.
func (pgb *ChainDBRPC) GetBlockVerboseByHash(hash string, verboseTx bool) *hxjson.GetBlockVerboseResult {
